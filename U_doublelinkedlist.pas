...
begin
  ...
  //gotoxy(20,4);
  writeln('A. TAMBAH SIMPUL BARU DI DEPAN LINKED LIST');
  //gotoxy(20,9);
  writeln('B. TAMBAH SIMPUL BARU DI BELAKANG LINKED LIST');
  //gotoxy(20,10);
  writeln('C. TAMPIL ISI SELURUH LINKED LIST');
  //gotoxy(20,11);
  writeln('D. SELESAI');
...
begin
  if n <> 0 then
  begin
    writeln('Tambah simpul baru di depan linked list');
...
begin
  ...
  if n <> 0 then
  begin
    writeln('Tambah simpul baru di akhir linked list');
...
begin
  i:=1;
  writeln('Membaca isi seluruh simpul Linkedlist');
